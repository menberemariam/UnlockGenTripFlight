  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // Animated banner / carousel (fixed / animated height)
            AnimatedBuilder(
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                padding: const EdgeInsets.only(bottom: 24.0), // less needed now
                child: Column(
                  ...
                  children: [
                    ...
                    // All middle content — now scrolls as part of the big list
                    const Padding(
                      padding: EdgeInsets.fromLTRB(8, 16, 8, 0),
                      child: FlightBookingMiddle(),
                    ),

                    // Extra space so last content isn't flush with bottom
                    const SizedBox(height: 20),
                  ],
                ),
              ),
...
// _buildAdBanner and _buildTabButton remain the same
